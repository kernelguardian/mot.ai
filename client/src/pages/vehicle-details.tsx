...
export default function VehicleDetails({ params }: VehicleDetailsProps) {
  ...
  const [expandedAdvisories, setExpandedAdvisories] = useState<Set<number>>(
    new Set(),
  );
      ...
      <div className="min-h-screen bg-white flex items-center justify-center">
        <Card className="max-w-md">
          <CardContent className="p-6 text-center">
            ...
            <h2 className="text-xl font-bold text-dvsa-blue mb-2">
              Vehicle Not Found
            </h2>
            <p className="text-gov-gray mb-4">
              Unable to find vehicle data for this link. The vehicle may not
              exist or the link may be invalid.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="hidden md:flex justify-between items-center">
            <div className="flex items-center space-x-4">
              ...
              <span className="font-plate text-xl text-dvsa-blue">
          ...
          <div className="md:hidden space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="font-plate text-lg text-dvsa-blue">
                {vehicle.registration}
              </span>
            </div>
            <div className="text-center">
            ...
            <CardContent className="p-6">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2">
                  <div className="space-y-4">
                    <div className="flex justify-between items-start">
                      <div>
                        <h2 className="text-xl font-semibold text-dvsa-blue">
                          ...
                          {vehicle.engineSize
                            ? `${parseFloat(vehicle.engineSize) / 1000}L`
                            : ""}
                        </h2>
                      ...
                      <div className="text-right">
                        <Badge
                          className={`${daysUntilExpiry && daysUntilExpiry >= 0 ? "bg-gov-green" : "bg-gov-red"} text-white`}
                        >
                    ...
                    <div className="grid grid-cols-2 gap-4 pt-4 border-t border-gray-200">
                      <div>
                        <label className="text-sm font-medium text-gov-gray">
                          MOT Expiry Date
                        </label>
                        <p className="text-lg font-semibold text-dvsa-blue">
                          {vehicle.motExpiryDate
                            ? formatDate(vehicle.motExpiryDate, false)
                            : "N/A"}
                        </p>
                      </div>
                      <div>
                        ...
                        <p
                          className={`text-lg font-semibold ${daysUntilExpiry && daysUntilExpiry < 30 ? "text-gov-red" : "text-gov-orange"}`}
                        >
                ...
                <div className="bg-gov-bg rounded-lg p-4">
                  <h3 className="font-semibold text-dvsa-blue mb-3">
                    MOT Statistics
                  </h3>
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      <span className="text-gov-gray text-sm">
                        Total Tests:
                      </span>
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-gov-red">
                        {stats.failures}
                      </span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-gov-green">
                        {stats.successRate}%
                      </span>
                    </div>
                  </div>
            ...
            <CardContent className="p-6">
              <div className="mb-6 p-4 bg-blue-50 rounded-lg border-l-4 border-dvsa-light-blue">
                <p className="text-sm text-dvsa-blue">
                  ...
                  Based on historical MOT data and vehicle patterns, our AI
                  identifies potential issues for your next test.
                </p>
              </div>
                    ...
                    <CardContent className="p-4">
                      <div className="flex justify-between items-start mb-3">
                        ...
                        <div className="text-right ml-4">
                          <Badge
                            className={`${getRiskLevelColor(prediction.riskLevel)} text-white`}
                          >
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        {prediction.recommendations && (
                          <Button
                            variant="link"
                            className="text-dvsa-light-blue hover:text-blue-800 text-sm font-medium p-0"
                          >
            ...
            <CardContent className="p-6">
              <div className="space-y-6">
                {motTests.map((test, index) => (
                  <div
                    key={test.id}
                    className={`relative pl-8 pb-6 ${index < motTests.length - 1 ? `border-l-2 ${test.testResult === "PASS" ? "border-gov-green" : "border-gov-red"}` : ""}`}
                  >
                    <div className="absolute -left-3 top-0">
                      <div
                        className={`${getTestStatusColor(test.testResult)} w-6 h-6 rounded-full`}
                      ></div>
                    </div>
                    <Card
                      ...
                      <CardContent className="p-4">
                        ...
                        {test.testResult === "FAILED" &&
                          ...
                          test.failures.length > 0 && (
                            <div className="mt-3">
                              <h4 className="font-medium text-gov-red mb-2">
                                Failure Reasons:
                              </h4>
                          ...
                          <div className="mt-3">
                            ...
                            {expandedAdvisories.has(test.id) && (
                              <div className="mt-2 p-3 bg-orange-50 rounded-lg border border-orange-200">
                                <ul className="text-sm text-gov-gray space-y-1">
                                  {test.advisories.map(
                                    (advisory: any, idx: number) => (
                                      <li
                                        key={idx}
                                        className="flex items-start"
                                      >
                                        <span className="text-gov-orange mr-2">
                                          •
                                        </span>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-3 pt-3 border-t border-gray-200">
                          ...
                          <div>
                            ...
                            <p
                              className={`font-medium ${test.testResult === "FAIL" ? "text-gov-red" : "text-gov-orange"}`}
                            >
                              {test.testResult === "FAIL"
              ...
              {motTests.length > 3 && (
                <div className="text-center mt-6">
                  <Button
                    variant="ghost"
                    className="text-dvsa-light-blue hover:text-blue-800 font-medium"
                  >
          ...
          <Card className="bg-blue-50 border border-dvsa-light-blue">
            <CardContent className="p-6">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-semibold text-dvsa-blue mb-2">
                    Important Disclaimer
                  </h3>
                  <p className="text-sm text-dvsa-blue leading-relaxed">
                    AI predictions are based on historical patterns and should
                    not replace professional vehicle inspection. Always consult
                    qualified mechanics and follow manufacturer guidelines.
                    MOT.AI is not affiliated with DVSA but uses official
                    government data. Prediction accuracy may vary and is
      ...
      <footer className="dvsa-blue text-white py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                <div className="bg-plate-yellow text-dvsa-blue px-2 py-1 rounded font-bold">
                  MOT.AI
                </div>
              </div>
              <p className="text-blue-100 text-sm">
                Intelligent MOT analysis powered by machine learning and
                official DVSA data.
              </p>
            </div>
          ...
          <div className="border-t border-blue-800 mt-8 pt-8 text-center text-sm text-blue-100">
            <p>
              &copy; 2024 MOT.AI. This service uses DVSA data but is not
              affiliated with or endorsed by DVSA.
            </p>
          </div>
        </div>
      </footer>
